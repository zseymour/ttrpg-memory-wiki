...
export const FAILURE_CATALOG: readonly CatalogEntry[] = [
  ...
  { id: "projection-as-record", description: "the projected page is treated as authoritative", pendingSubsystem: "projection/intake" },
  { id: "byte-diff-as-edit", description: "a byte diff is treated as semantic evidence", pendingSubsystem: "projection/intake" },
  { id: "auto-accepted-intake", description: "ambiguous edits are auto-accepted without confirmation", pendingSubsystem: "projection/intake" },
